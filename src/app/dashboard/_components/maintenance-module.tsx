...
import type { Car, FinancialAccount, RepairItem, RepairItemCategory, RepairItemStatus } from "@/lib/supabase/types";
...
export function MaintenanceModule({
  ...
  /** 2026-09-04 新增：核准撥款時選帳戶用，見 car-maintenance-tab.tsx 的
   * RepairItemRow。 */
  ...
  // 2026-09-05 修正：捲完之後把網址上的 highlight 參數清掉，不然使用者
  // 手動重新整理頁面會一直重複自動捲動——理由跟 cars-manager.tsx 那個
  // 「一重新整理就自動彈出表單」的修正完全一樣，見那邊的詳細說明。
  useEffect(() => {
